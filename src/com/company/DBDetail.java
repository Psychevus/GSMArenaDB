        ...
        try {
            ...
            String SQL =
                    "CREATE TABLE DETAILS " +
                            ...
                            " NETWORK_2GBands                 TEXT," +
                            " NETWORK_3GBands                 TEXT," +
                            " NETWORK_4GBands                 TEXT," +
                            " NETWORK_Speed                   TEXT," +
                            " NETWORK_GPRS                    TEXT," +
                            " NETWORK_EDGE                    TEXT," +
                            ...
                            " FEATURES_Messaging              TEXT," +
                            " FEATURES_Browser                TEXT," +
                            " FEATURES_Java                   TEXT," +
                            " FEATURES_                       TEXT," +

                            " BATTERY_                        TEXT," +
                            " BATTERY_StandBy                 TEXT," +
                            " BATTERY_TalkTime                TEXT," +
                            " BATTERY_MusicPlay               TEXT," +

                            " MISC_Colors                     TEXT," +
                            " MISC_PriceGroup                 TEXT)";
